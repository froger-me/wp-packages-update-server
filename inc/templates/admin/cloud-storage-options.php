...
<h3><?php esc_html_e( 'Cloud Storage', 'wppus' ); ?></h3>
	...
	<tr class="hide-if-no-cloud-storage <?php echo ( $use_cloud_storage ) ? '' : 'hidden'; ?>">
		...
		<td>
			<input class="regular-text cloud-storage-setting secret" type="password" autocomplete="new-password" id="wppus_cloud_storage_access_key" name="wppus_cloud_storage_access_key" value="<?php echo esc_attr( get_option( 'wppus_cloud_storage_access_key' ) ); ?>">
			<p class="description">
	...
	<tr class="hide-if-no-cloud-storage <?php echo ( $use_cloud_storage ) ? '' : 'hidden'; ?>">
		...
		<td>
			<input class="regular-text cloud-storage-setting secret" type="password" autocomplete="new-password" id="wppus_cloud_storage_secret_key" name="wppus_cloud_storage_secret_key" value="<?php echo esc_attr( get_option( 'wppus_cloud_storage_secret_key' ) ); ?>">
			<p class="description">
	...
	<tr class="hide-if-no-cloud-storage <?php echo ( $use_cloud_storage ) ? '' : 'hidden'; ?>">
		...
		<td>
			...
			<p class="description">
				<?php esc_html_e( 'Send a test request to the Cloud Storage Service.', 'wppus' ); ?>
				<br/>
