	...
	<form action="" method="post">
		<table class="form-table package-source">
			...
			<tr>
				...
				<td>
					<input class="remote-repository-setting regular-text" type="text" id="wppus_remote_repository_credentials" name="wppus_remote_repository_credentials" value="<?php echo esc_attr( get_option( 'wppus_remote_repository_credentials' ) ); ?>">
					<p class="description">
