...
Name                                     | Description
---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Package Private API Authentication Keys  | Multiple values ; creating a key required a "Package Key ID" used to identify the package key.<br>Used to get tokens for package administration requests (browse, read, edit, add, delete) and requests of signed URLs of package.<br>The Package Key ID must contain on numbers, letters, `-` and `_`.<br>**WARNING: Keep these keys secret, do not share any of them with customers!**
...
License Private API Authentication Keys	 | Multiple values ; creating a key required a "License Key ID" used to identify the package key.<br>Used to get tokens for license administration requests (browse, read, edit, add, delete).<br>The License Key ID must contain on numbers, letters, `-` and `_`.<br>**WARNING: Keep these keys secret, do not share any of them with customers!**
